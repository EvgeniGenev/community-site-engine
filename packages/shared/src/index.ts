...
export const SiteSettingsSchema = z.object({
  ...
  navGradientStart: z.string().optional(),
  navGradientEnd: z.string().optional(),
  navBorderColor: z.string().optional(),
  navTextColor: z.string().optional(),
  navHoverBgColor: z.string().optional(),
  navLangBgColor: z.string().optional(),
  navLangTextColor: z.string().optional(),
  navLangActiveBgColor: z.string().optional(),
  navDropdownBgColor: z.string().optional(),
  navDropdownBorderColor: z.string().optional(),
  navDropdownTextColor: z.string().optional(),
  navDropdownHoverBgColor: z.string().optional(),
  navDropdownHoverTextColor: z.string().optional(),
  buttonTextPrimary: z.string().optional(),
  buttonTextSecondary: z.string().optional(),
  cardBg: z.string().optional(),
  eventCardBg: z.string().optional(),
  galleryDialogBg: z.string().optional(),
  galleryDialogBackdrop: z.string().optional(),
  ctaText: z.string().optional(),
  ctaTextMuted: z.string().optional(),
  footerText: z.string().optional(),
  footerLinkHover: z.string().optional(),
  editButtonBg: z.string().optional(),
  miniHeroBg: z.string().optional(),
  miniHeroText: z.string().optional(),
  miniHeroPadding: z.string().optional(),
  ...
  themeInk: z.string().optional(),
  themeMuted: z.string().optional(),
  themePaper: z.string().optional(),
  themeSoft: z.string().optional(),
  themeLine: z.string().optional(),
  themeRed: z.string().optional(),
  themeRedDark: z.string().optional(),
  themeGold: z.string().optional()
...
export const ThemeSchema = z.object({
  ...
  name: z.string().min(1),
  colors: z.object({
    backgroundMode: z.enum(["gradient", "solid"]).optional(),
    backgroundColor: z.string().optional(),
    backgroundGradientStart: z.string().optional(),
    backgroundGradientEnd: z.string().optional(),
    navBackgroundMode: z.enum(["transparent", "gradient", "solid"]).optional(),
    navBackgroundColor: z.string().optional(),
    navGradientStart: z.string().optional(),
    navGradientEnd: z.string().optional(),
    navBorderColor: z.string().optional(),
    navTextColor: z.string().optional(),
